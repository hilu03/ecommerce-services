...
public enum ErrorCode {
    ...
    CATEGORY_NAME_EXISTED("Category name existed", HttpStatus.NOT_FOUND),
    ...
    ALREADY_REVIEWD("Already reviewed", HttpStatus.BAD_REQUEST),
    ...
    OVERLAPPING_FEATURED_PRODUCT("Overlapping featured product", HttpStatus.BAD_REQUEST),
    ;
